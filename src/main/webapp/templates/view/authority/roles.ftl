                    ...
                    <form method="POST">
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control" name="roleCode" id="roleCode" value="${role.roleCode}">
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control" name="roleDescription" id="roleDescription" value="${role.roleDescription}">
                            </div>
                        </div>
