                    ...
                    <ul class="navigation navigation-main navigation-accordion">
                        ...
                        <li>
                            <a href="/">
                                ...
                                <span><@spring.message code='survey.menu.dashboard'/></span>
                            </a>
                        </li>
                        <li>
                            <a href="#"><i class="icon-copy"></i>
                                <span><@spring.message code='survey.menu.authorityManagement'/></span>
                            </a>
                            <ul>
                                <li><a href="/authority/roles"
                                       id="roles"><@spring.message code='survey.menu.roles'/></a></li>
                            </ul>
                        </li>
